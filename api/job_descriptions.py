...
def create_job_description_with_skills(job: JobDescription, required_skill_ids: List[str], preferred_skill_ids: List[str]) -> JobDescription:
    """
...
def update_job_description_with_skills(job_id: str, updates: Dict[str, Any], required_skill_ids: List[str], preferred_skill_ids: List[str]) -> JobDescription:
    """
